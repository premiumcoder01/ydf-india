...
export default function ReviewerEditProfileScreen() {
                    ...
                    if (authData.token) {
                        ...
                        if (response.success && response.data?.user) {
                            ...
                            setFormData({
                                ...
                                email: user.email || "",
                                phone: user.phone1 || "",
                                organization: user.address || "", // Assuming address field used for org
                                department: user.department || "",
                                role: "Reviewer", // Hardcoded for now
                            });
                        }
                    }
                }
    ...
    const handleSave = async () => {
        try {
            ...
            // Simulated update call
            // In real scenario: const response = await updateUserProfile(token, formData);
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            >
                ...
                <CustomTextInput
                    ...
                    onChangeText={(t) => setFormData(prev => ({ ...prev, department: t }))}
